...
module.exports = {
  ...
  source: {
    ...
    lessImport   : './semantic/semantic.less',
    site         : './semantic/_site',
    tasks        : './tasks',
    themeConfig  : './semantic/theme.config.example',
    themeImport  : './semantic/theme.less',
    themes       : './semantic/themes',
    defaultTheme : './semantic/themes/default',
  ...
  files: {
    ...
    lessImport  : 'semantic/semantic.less',
    site        : 'semantic/site',
    themeConfig : 'semantic/theme.config',
    themeImport : 'semantic/theme.less'
  },
    ...
    setup: [
      ...
      },
      {
        ...
        choices: [
          ...
          {
            name: 'Custom (Customize all semantic/dist values)',
            value: 'custom'
          }
        ]
      },
