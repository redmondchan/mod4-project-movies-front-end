      ...
      if(distribution == 'CSS') {
        ...
        gulp.task(task.repo, function() {
          var
            ...
            themes
          ;
          definitions = gulp.src('semantic/definitions/**/*', { base: 'semantic/' })
            .pipe(gulp.dest(outputDirectory))
          ;
          themeImport = gulp.src('semantic/semantic.less', { base: 'semantic/' })
            .pipe(gulp.dest(outputDirectory))
          ;
          themeImport = gulp.src('semantic/theme.less', { base: 'semantic/' })
            .pipe(gulp.dest(outputDirectory))
          ;
          themeConfig = gulp.src('semantic/theme.config.example', { base: 'semantic/' })
            .pipe(gulp.dest(outputDirectory))
          ;
          siteTheme = gulp.src('semantic/_site/**/*', { base: 'semantic/' })
            .pipe(gulp.dest(outputDirectory))
          ;
          themes = gulp.src('semantic/themes/**/*', { base: 'semantic/' })
            .pipe(gulp.dest(outputDirectory))
          ;
